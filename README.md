...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/pyzmq-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pyzmq-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
It is possible to list all of the versions of `pyzmq` available on your platform:
...
```
pixi search pyzmq --channel conda-forge
```
